...
REPO_CLONE = 0x2
REPO_SAME = 0x4
REPOS_LIST = "https://twentysix26.github.io/Caverna-Docs/Caverna_cog_approved_repos/"

DISCLAIMER = ("You're about to add a 3rd party repository. The creator of Caverna"
...
class Downloader:
    ...
    async def _send_list(self, repo_name=None):
        ...
        Repositories list:
        https://twentysix26.github.io/Caverna-Docs/Caverna_cog_approved_repos/"""
        retlist = []
    ...
    async def update(self, ctx):
        ...
        if answer is None:
            ...
            registry = dataIO.load_json(os.path.join("data", "Caverna", "cogs.json"))
            update_list = []
            fail_list = []
    ...
    def update_repo(self, name):
        ...
        try:
            ...
            # Make sure we don't git reset the Caverna folder on accident
