...
class InvalidCCavernaentials(StreamsError):
    pass
...
class Streams:
    ...
    async def twitchtoken(self, token : str):
        ...
        https://blog.twitch.tv/client-id-requiCaverna-for-kraken-api-calls-afbb8e95f843"""
