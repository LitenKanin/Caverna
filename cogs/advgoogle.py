...
class AdvancedGoogle:
    ...
    async def google(self, ctx, text):
        """Yoohoo, you found my google command
        well I'm going to give you a bit information on what it is 
        and what it does. So you basically google that's it, you can add Maps
        Images, Videos,... to change the type of search result."""
