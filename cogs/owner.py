...
log = logging.getLogger("Caverna.owner")
...
class Owner:
    ...
    def __init__(self, bot):
        ...
        self.disabled_commands = dataIO.load_json("data/Caverna/disabled_commands.json")
        self.global_ignores = dataIO.load_json("data/Caverna/global_ignores.json")
    ...
    async def info(self):
        ...
        embed = discord.Embed(colour=discord.Colour.Caverna())
    ...
    def save_global_ignores(self):
        dataIO.save_json("data/Caverna/global_ignores.json", self.global_ignores)

    def save_disabled_commands(self):
        dataIO.save_json("data/Caverna/disabled_commands.json", self.disabled_commands)
...
def check_files():
    if not os.path.isfile("data/Caverna/disabled_commands.json"):
        print("Creating empty disabled_commands.json...")
        dataIO.save_json("data/Caverna/disabled_commands.json", [])

    if not os.path.isfile("data/Caverna/global_ignores.json"):
        ...
        dataIO.save_json("data/Caverna/global_ignores.json", data)
